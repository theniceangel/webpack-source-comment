...
class Compiler extends Tapable {
	constructor(context) {
		...
		// compiler.plugin(name, fn) 的时候，如果 name 为下面的值
		// 就会走到下面的 handler 逻辑，将 async 设置为 true
	...
	// 生成 NormalModuleFactory 实例，并且调用
	createNormalModuleFactory() {
		...
		// call normalModuleFactory(SyncHook)
	...
	compile(callback) {
		...
		// call beforeCompile(AsyncSeriesHook)
		this.hooks.beforeCompile.callAsync(params, err => {
			if (err) return callback(err);
			// call compile(SyncHook)
